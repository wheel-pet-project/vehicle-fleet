...
[TestSubject(typeof(ReleaseVehicleHandler))]
public class ReleaseVehicleHandlerShould
{
    private readonly ReleaseVehicleRequest _request = new(Guid.NewGuid());
    ...
    private readonly ReleaseVehicleHandler _handler;
    ...
    public ReleaseVehicleHandlerShould()
    {
        ...
        _handler = new ReleaseVehicleHandler(_vehicleRepositoryMock.Object,
